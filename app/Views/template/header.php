    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="index.php">
                ...
                <img src="<?= base_url() ?>/assets/images/brand/BRI-1.png" class="header-brand-img dark-logo" alt="Azea logo">
                            ...
                            <!-- <div class="dropdown header-message d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow  animated">
                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <a class="dropdown-item border-bottom" href="chat.php">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?= base_url() ?>/assets/images/users/1.jpg"></span>
                                                </div>
                                        ...
                                        <a class="dropdown-item border-bottom" href="chat.php">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?= base_url() ?>/assets/images/users/2.jpg"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom" href="chat.php">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?= base_url() ?>/assets/images/users/3.jpg"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom" href="chat.php">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?= base_url() ?>/assets/images/users/4.jpg"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom" href="chat.php">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?= base_url() ?>/assets/images/users/6.jpg"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item" href="chat.php">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?= base_url() ?>/assets/images/users/7.jpg"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                    ...
                                    <div class=" text-center p-2 pt-3 border-top">
                                        <a href="chat.php" class="fs-13 btn btn-primary btn-md btn-block">See More</a>
                                    </div>
                                </div>
                            </div> -->
                            <!-- <div class="dropdown header-notify d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow  animated">
                                    ...
                                    <div class="notify-menu">
                                        <a href="email-inbox.php" class="dropdown-item border-bottom d-flex ps-4">
                                        ...
                                        <a href="email-inbox.php" class="dropdown-item border-bottom d-flex ps-4 mb-2">
                                    ...
                                    <div class=" text-center p-2">
                                        <a href="email-inbox.php" class="btn btn-primary btn-md fs-13 btn-block">View All</a>
                                    </div>
                                </div>
                            </div> -->
                            <div class="dropdown profile-dropdown d-flex">
                                <a href="javascript:void(0);" class="nav-link pe-0 leading-none" data-bs-toggle="dropdown">
                                    <span class="header-avatar1">
                                        <img src="<?= base_url() ?>/assets/images/users/2.jpg" alt="img" class="avatar avatar-md brround">
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    <div class="text-center">
                                        <div class="text-center user pb-0 font-weight-bold">Adam</div>
                                        <span class="text-center user-semi-title">HCBP Jakarta</span>
                                        <div class="dropdown-divider"></div>
                                    </div>
                                    <a class="dropdown-item d-flex" href="profile-1.php">
                                    ...
                                    <a class="dropdown-item d-flex" href="search.php">
                                        <svg class="header-icon me-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none" />
