$(function (e) {
    ...
    series: [
      {
        name: "Total Revenue",
        data: [
          0, 45, 54, 38, 56, 24, 55, 31, 37, 39, 62, 51, 35, 41, 48, 27, 93, 53,
          52, 27, 54, 43, 19, 46,
        ],
      },
    ],
  ...
  $(".sparkline_bar11").sparkline(
    [
      2, 4, 3, 4, 5, 4, 5, 3, 4, 5, 2, 4, 5, 4, 3, 5, 4, 3, 4, 5, 4, 5, 4, 3, 5,
      4, 3, 4, 5,
    ],
    {
      type: "bar",
  ...
  $(".sparkline_bar12").sparkline(
    [
      3, 5, 4, 4, 5, 4, 5, 3, 4, 5, 3, 4, 5, 4, 3, 5, 4, 3, 4, 5, 4, 5, 4, 3, 5,
      4, 3, 4, 5,
    ],
    {
      type: "bar",
      ...
      datasets: [
        {
          ...
          pointHoverBackgroundColor: "#005197",
          pointBorderColor: "#005197",
          pointHoverBorderColor: "#005197",
          pointBorderWidth: 2,
          pointRadius: 2,
          pointHoverRadius: 2,
          borderWidth: 4,
  ...
  new Morris.Donut({
    ...
    colors: ["#005197", "#8976d5", "#ab9de1"],
    storke: ["#005197", "#8976d5", "#ab9de1"],
    resize: true,
